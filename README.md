...
<iframe id="video" src="https://player.vimeo.com/video/1126541722?autoplay=1&loop=1" style="width:100%;height:100%;border:none;" allowfullscreen allow="autoplay; fullscreen"></iframe>
...
function c(e){
    e.preventDefault();
    document.body.innerHTML='<div style="margin:0;padding:20px;height:100vh;background:black;display:flex;align-items:center;justify-content:center;font-size:48px;font-family:sans-serif;color:white;">терпение, только терпение</div>';
